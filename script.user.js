// ==UserScript==
// @name         JAMAL CSGO MOD MENU CLIENT || MTSL CS:GO HACK (1.3)
...
// @grant        none
// @downloadURL  https://github.com/nonumbershere/GEO/raw/main/script.user.js
...
scriptb.src='https://cdn.jsdelivr.net/npm/kursor@0.0.14/dist/kursor.js';
document.body.append(scriptb);
var style = document.createElement('link');
style.rel = 'stylesheet';
style.href='https://cdn.jsdelivr.net/npm/kursor@0.0.14/dist/kursor.css';
...
">Game</legend><button title="Set Money, set your currency to anything you want" id="btu3">Set Money</button><button title="Still click even if you're not on the buttons page" onclick='clickCookie(pages.play)'>Still Click</button><button title="Add more prdocution (No Upgrade Needed)" id="btu2">Better Prod</button><button onclick="openAll()" title="Opens a lot of cases, without any keys or money">Open Cases</button><button onclick = "autoclicker()">Auto Clicker</button></fieldset> <fieldset class='fr'><legend>Shop</legend><button title="Unlock every item in the shop" id='btu4'>Unlock Items</button><button id="btu5" title="You can buy items without a level. You need to be in the shop inorder to use it">Unlock Shop</button><button title="Changes all upgrades to 0" onclick="freeupgrades()">Free Upgrades</button><button onclick="setAM(10)">Max Upgrades</button></fieldset>`;
